...
class TemperatureMachine(StateMachine):
    ...
    def processTempIncButton(self):
        ...
        self.setPoint += 1
        # Signal we need to update our LEDs
    ...
    def setupSerialOutput(self):        
        output = f"| - State: {self.current_state.id} | Temp: {round(self.getFahrenheit(), 1)}F | Set Point: {self.setPoint}F - |"
        return output
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = f"{self.current_state.id.title()} SP:{self.setPoint} F"
            ...
            if self.setpointChanged:
                self.updateLights()
                self.setpointChanged = False
...
yellowButton.when_pressed = tsm.processTempStateButton
